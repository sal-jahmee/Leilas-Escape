...
class GameScene: SKScene {
    ...
    var initialDialogs = ["dialog_1", "dialog_2", "dialog_3", "dialog_4", "dialog_5", "dialog_6"]
    var secondaryDialogs = ["dialog_7", "dialog_8"]
    ...
    override func didMove(to view: SKView) {
        ...
        let spider = Spider(screenSize: self.size)//Shakira- added spider Animation
        addChild(spider)
...
//        wisp.position = CGPoint(x: -15, y: 0)
...
//        addChild(wisp)
    ...
    func proceedToNextLevel() {
        ...
        // Load the next scene
        if let nextScene = SKScene(fileNamed: "ThePotionScene") {
